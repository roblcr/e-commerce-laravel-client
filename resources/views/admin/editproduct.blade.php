                ...
                <div class="card-body">
                  ...
                  @if (Session::has('status'))
                    ...
                    @endif
                      ...
                      {!! Form::open(['action' => 'App\Http\Controllers\ProductController@editproduct', 'method' => 'POST', 'class' => 'cmxform', 'id' => 'commentForm', 'enctype' => 'multipart/form-data']) !!}
                      {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        {!! Form::select('product_category', $category, $product->product_category, ['class' => 'form-control']) !!}
                      </div>
                      <div class="form-group">
